...
def download(url: str) -> None:
    """Download a file from `url` into the current working directory.

    The file is skipped if a local copy already exists and its size matches
    the remote `Content-Length` header.

    Args:
        url: The URL of the file to download. The local filename is derived
